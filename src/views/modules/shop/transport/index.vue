...
const getDataList = (pageParam, params, done) => {
  http({
    url: http.adornUrl('/transport/page'),
    method: 'get',
    params: http.adornParams(
      Object.assign(
        {
          pageNum: pageParam == null ? page.value.currentPage : pageParam.currentPage,
          pageSize: pageParam == null ? page.value.pageSize : pageParam.pageSize
        },
        params
      )
    )
