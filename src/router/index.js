...
export const mainRoutes = {
    ...
    children: [
        ...
        {
            path: '/prodInfo', name: 'prodInfo', component: () => import('@/views/modules/prod/prodInfo/index.vue')
        }],
...
const router = createRouter({
    history: createWebHistory(import.meta.env.BASE_URL),// 忽略浏览器的 URL 而使用其自己内部的 URL。
...
router.beforeEach((to, from, next) => {
    ...
    if (router.options.isAddDynamicMenuRoutes || fnCurrentRouteType(to, globalRoutes) === 'global') {
        ...
        console.log('[http.js] 获取列表 ======', userStore.token)
        http({
            ...
            console.log('[http.js] menu请求 ======', `${JSON.stringify(data.data || '[]')}`)
