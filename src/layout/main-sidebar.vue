...
const toHome = () => {
  console.log('[main-sidebar.vue] toHome ======')
...
const routeHandle = route => {
  console.log('[main-sidebar.vue] routeHandle ======')
  if (route.name === 'home') {
    expandMenuList.value = []
    sessionStorage.setItem('isExpand', '0')
    commonStore.updateSelectLeftId('')
...
const gotoRouteHandle = menu => {
  console.log('[main-sidebar.vue] gotoRouteHandle  menu.url ======', `${menu.url}`)
...
const expandMenu = menu => {
  console.log('[main-sidebar.vue] expandMenu ======')
...
const routeJump = menu => {
  console.log('[main-sidebar.vue] routeJump ======')
